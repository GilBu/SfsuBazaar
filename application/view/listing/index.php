	...
	<div id="products" class="row-fluid list-group">
		<div id="products" class="row-fluid list-group">
			...
			<div class="product  col-xs-3 col-lg-3">
				<div class="thumbnail">
					<img class="group list-group-image" src="http://placehold.it/350x450/000/fff" alt=""/>
					<div class="caption">
						...
						<div class="row" align="center">
							<div class="col-xs-12 col-md-6">
								<a class="btn btn-success btn-xs" href="#">Add to cart</a>
							</div>
							<div class="col-xs-12 col-md-6">
								<a class="btn btn-success btn-xs" href="#">Buy It Now</a>
							</div>
						</div> <!-- end row -->
					</div>
				</div>
			...
			<div class="product  col-xs-3 col-lg-3">
				<div class="thumbnail">
					<img class="group list-group-image" src="http://placehold.it/250x250/000/fff" alt="" />
					<div class="caption">
						<h4 class="group inner list-group-product-heading">
							<b>Product title</b>
						</h4>
